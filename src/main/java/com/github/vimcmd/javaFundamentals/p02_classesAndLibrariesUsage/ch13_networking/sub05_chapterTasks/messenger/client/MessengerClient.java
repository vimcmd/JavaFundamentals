package com.github.vimcmd.javaFundamentals.p02_classesAndLibrariesUsage.ch13_networking.sub05_chapterTasks.messenger.client;
...
public class MessengerClient implements SimpleClient {
    public static void main(String[] args) {
        ...
        try {
            ...
            printStream.println("anonymous message #everyone");
